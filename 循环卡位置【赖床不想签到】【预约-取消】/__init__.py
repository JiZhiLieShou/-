...
def get_userid_from_txt(session, libiary_username, libiary_password):  # 获取user_id（取代 user_id = "181919"  # 使用者id 人名1：185469 人名2：181919）
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # 取消预约
        sleep(3540)# 延时3540秒-即59分 预约与取消预约的间隔时间
