...
def get_cookie():
    ...
    time.sleep(2)
    driver.find_element(By.XPATH, '//*[@id="credentials"]/ul/li[2]/input').send_keys('201xxxxxxxx')
    driver.find_element(By.XPATH, '//*[@id="credentials"]/ul/li[3]/input').send_keys('20xxxxxxxxxx')
